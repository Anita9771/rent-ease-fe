...
export default function PropertyManagerLayout({ children }: { children: ReactNode }) {
  const pathname = usePathname();

  // Don't show sidebar on auth routes (login, accept-invite)
    ...
    <ProtectedRoute>
      <div className="min-h-screen bg-brand-mist">
        <div className="grid min-h-screen grid-cols-[auto,1fr]">
          <Sidebar variant="property-manager" />
